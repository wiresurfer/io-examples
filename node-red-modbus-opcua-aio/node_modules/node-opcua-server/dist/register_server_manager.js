...
class RegisterServerManager extends events_1.EventEmitter {
    ...
    _establish_initial_connection(outer_callback) {
        ...
        const client = node_opcua_client_1.OPCUAClientBase.create({
            ...
            applicationName: ((_a = node_opcua_client_1.coerceLocalizedText(this.server.serverInfo.applicationName)) === null || _a === void 0 ? void 0 : _a.toString()) || undefined,
    ...
    _registerServer(isOnline, outer_callback) {
        ...
        const options = {
            ...
            applicationName: ((_b = node_opcua_client_1.coerceLocalizedText(server.serverInfo.applicationName)) === null || _b === void 0 ? void 0 : _b.toString()) || undefined,
